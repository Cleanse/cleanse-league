...
class ManagerChampionshipCreate extends ComponentBase
{
    public $championship;
    ...
    public function componentDetails()
    {
        return [
            ...
            'description' => 'Create a Championship.'
        ];
    }
    ...
    {
        $this->championship = Championship::orderBy('id', 'desc')->first();
        ...
        return [
            [
                ...
                'placeholder' => '2017 Aether League Championship',
                'default' => $this->championship->name ?? ''
            ],
            [
                'name' => 'rules',
                'type' => 'textarea',
                'label' => 'Rules',
                'validation' => [['validation_type' => 'required', 'validation_error' => 'Required.']],
                'default' => $this->championship->rules ?? ''
            ]
        ];
    }
    ...
    public function getSubmitButtonHtmlCode()
    {
        ...
        $output[] = 'Update Championship Information';
